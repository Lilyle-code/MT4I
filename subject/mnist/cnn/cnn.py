...
# 训练数据集和测试数据集
ox, oy = lm.load_mnist('E:/研究生/a实验室/目标识别数据集/MNIST_data/', 'train')
tx, ty = lm.load_mnist('E:/研究生/a实验室/目标识别数据集/MNIST_data/', 't10k')
...
with tf.Session() as sess:
    ...
    for i in range(40000):
       ...
       #writer.add_summary(ac,i)
        if  (i+1)  == 40000:
            saver.save(sess,"final1/classify",global_step=40000)
